...
pub fn log_startup_settings(config: &Config) {
    info!(
        ...
        challenge_issuance_burst = config.challenge_issuance_burst,
        challenge_max_clients = config.challenge_max_clients,
        ...
        global_admission = "tower_load_shed",
        challenge_client_admission = "when_client_address_resolved",
