...
public enum DiagnosticOperation: String, Codable, Sendable {
    ...
    case importStatistics = "import_statistics"
...
public enum DiagnosticFailureCode: String, Codable, Sendable {
    ...
    case statisticsPersistenceFailed = "statistics_persistence_failed"
    case statisticsInvalidArchive = "statistics_archive_invalid"
    case statisticsInvalidAccountMapping = "statistics_account_mapping_invalid"
    ...
    case privateCloudCallbackTimedOut = "private_cloud_callback_timed_out"
    case privateCloudStopping = "private_cloud_stopping"
...
public struct PrivateCloudDiagnosticDetail: Codable, Equatable, Sendable {
    ...
    public init(
        ...
        case .disabled, .cancelled, .callbackTimedOut, .stopping,
            .invalidRecord, .persistenceFailed,
...
extension PrivateCloudSyncError {
    public var diagnosticFailureCode: DiagnosticFailureCode {
        ...
        case .callbackTimedOut: .privateCloudCallbackTimedOut
        case .stopping: .privateCloudStopping
