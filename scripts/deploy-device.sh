...
: "${BLEAT_TELEMETRY_AUTH_BASE_URL:?Set BLEAT_TELEMETRY_AUTH_BASE_URL to the telemetry auth base URL}"
: "${BLEAT_TELEMETRY_OTLP_ENDPOINT:?Set BLEAT_TELEMETRY_OTLP_ENDPOINT to the telemetry OTLP endpoint}"
