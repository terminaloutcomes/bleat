...
# Keep Docker mounts outside the output directory recreated between runs.
readonly bleat_work_directory="${bleat_repository_root}/.build/release-screenshot-work-${bleat_run_id}"
